...
CHECKPOINT="/vepfs-mlp2/c20250502/haoce/wlb/recogdrive/exp/exp_mlp_public/training_qwen3vl_backbone_agent_dit_alignment_100epoch_LoRA_batchsize_128/checkpoints_128/lightning_logs/version_0/checkpoints/epoch=59-step=39900-EMA.ckpt"
...
torchrun \
    ...
    agent.action_head_checkpoint_path="'/vepfs-mlp2/c20250502/haoce/wlb/recogdrive/exp/training_recogdrive_agent_qwen3vl_worldmirror_alignment_60epoch_LoRA_batchsize_128_post_100epoch/2026.01.02.12.30.52/lightning_logs/version_0/checkpoints/epoch=99-step=66500-EMA.ckpt'" \
    ...
    experiment_name='recogdrive_agent_eval/batchsize_128_post-training_epoch100' \
